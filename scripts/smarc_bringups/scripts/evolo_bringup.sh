...
# Controllers
CONTROLLER_CMD="ros2 launch evolo_controllers evolo_controllers_launch.py closed_loop_p_gain:=1.0 closed_loop_i_gain:=0.1 closed_loop_d_gain:=0.0 max_steering_output:=40.0 max_integral:=10.0"
